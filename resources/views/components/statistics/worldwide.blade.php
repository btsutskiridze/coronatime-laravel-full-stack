<section class="mt-6 lg:my-10 grid lg:grid-flow-col ">
    ...
    flex justify-center items-center flex-col">
        ...
        <img src="/images/new-cases.svg" alt="">
        <h1 class="font-medium text-base sm:text-xl my-4  sm:mt-6 sm:mb-4">New Cases</h1>
    ...
    flex justify-center items-center flex-col">
        <img src="/images/recovered.svg" alt="">
        <h1 class="font-medium text-base sm:text-xl my-4  sm:mt-6 sm:mb-4">Recovered</h1>
    ...
    flex justify-center items-center flex-col ">
        ...
        <h1 class="font-medium  text-base sm:text-xl my-4  sm:mt-6 sm:mb-4">Death</h1>
