<form>
    ...
    <div class="relative">
        ...
        <button type="submit"
            class="text-white absolute right-2.5 bottom-[7px] bg-[#0FBA68] font-black uppercase rounded-[27px] leading-[16px] text-sm px-8 py-4 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Send</button>
    </div>
</form>
